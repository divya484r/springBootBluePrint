...
<!--
  Unapologetically stolen from https://github.com/findbugsproject/findbugs/tree/master/findbugs/src/xsl, and
  modifying the report to say "spotbugs" instead of "findbugs".
  Note that one must decorate the generated XML; look for "xml.withMessages = true" in this project.
-->
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <p>Produced using <a href="https://spotbugs.github.io/">SpotBugs</a><xsl:text> </xsl:text><xsl:value-of select="/BugCollection/@version"/>.</p>
                <p>Project:
                    <xsl:choose>
